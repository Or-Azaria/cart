...
function changeWeather(response, temp) {
  if (temp <= 0) {
    body.style.backgroundImage =
      "url(./assets/photo-1478719059408-592965723cbc.avif)";
  } else if (response == `overcast clouds` || response == "scattered clouds") {
    body.style.backgroundImage =
...
btn.addEventListener("click", function () {
  ...
  if (cityName != "") {
    ...
    let humidity;
    let time = new Date();
    const API_one = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=57d089aa08a6b287669bca5a71b82149`;
    let xhr = new XMLHttpRequest();
    xhr.open(`GET`, API_one);
    xhr.onload = function () {
...
const URL_API = 'https://api.openweathermap.org/data/2.5/weather?q=Jerusalem&appid=57d089aa08a6b287669bca5a71b82149'
fetch(URL_API)
